...
public class CategoriasResources {
	...
	public ResponseEntity<List<CategoriaDTO>> buscarTodos() {
		...
		List<CategoriaDTO> obj = aux.stream().map((obj2) -> (new CategoriaDTO(obj2))).collect(Collectors.toList()); // gamb
																													// detected
	...
	public ResponseEntity<Page<CategoriaDTO>> buscarPage(@RequestParam(name = "p", defaultValue = "0") Integer page,
